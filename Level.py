...
class Level:
    ...
    def generate_world_map(self):
        self.tile_map_world = [
            ...
            [31, 10, 10, 10, 57, 33, 21, 21, 21, 34, 41, 33, 21, 21, 21, 21, 21, 21, 21, 10],
            [31, 12, 11, 10, 10, 10, 42, 42, 42, 11, 10, 10, 10, 10, 10, 11, 10, 10, 10, 32],
            [31, 13, 10, 10, 12, 11, 42, 42, 42, 69, 10, 10, 11, 10, 11, 10, 10, 10, 13, 32],
            [31, 10, 10, 10, 57, 36, 22, 22, 22, 35, 10, 10, 10, 10, 13, 12, 12, 12, 10, 32],
